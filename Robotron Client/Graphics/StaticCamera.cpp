...
********************/
bool CStaticCamera::Initialise(D3DXVECTOR3 _v3Position, D3DXVECTOR3 _v3LookAt, bool _bFirstPerson)
{
...
* @return: void
********************/
void CStaticCamera::Process(IRenderer* _pRenderer)
{
...
* @return: void
********************/
void CStaticCamera::SetPosition(D3DXVECTOR3 _vecPosition)
{
...
* @return: void
********************/
void CStaticCamera::SetCamera(D3DXVECTOR3 _v3Target, D3DXVECTOR3 _v3Position, D3DXVECTOR3 _v3Up, D3DXVECTOR3 _v3Look)
{
...
* @return: void
********************/
void CStaticCamera::SetMode(bool _bFirstPerson)
{
	m_bFirstPerson = _bFirstPerson;
}
...
********************/
bool CStaticCamera::GetCameraMode()
{
...
********************/
D3DXVECTOR3* CStaticCamera::GetPosition()
{
	return &m_v3Position;
}
...
********************/
D3DXVECTOR3* CStaticCamera::GetTarget()
{
	return &m_v3Target;
}
